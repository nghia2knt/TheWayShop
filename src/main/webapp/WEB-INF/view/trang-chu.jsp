                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="m-b-40">Hãy mua sắm theo sở thích của bạn <br> Đam mê của bạn là sự hài lòng của chúng tôi.</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>SẢN PHẨM</h1>
                        <p>Hãy mua sắm theo sở thích của bạn <br> Đam mê của bạn là sự hài lòng của chúng tôi.</p>
                    </div>
                </div>
            </div>
            <div class="row">
