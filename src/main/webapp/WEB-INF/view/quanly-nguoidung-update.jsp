...
<body>
  ...
  <div class="container">
	...
	<h3></h3>
	<hr>
	 <form:form accept-charset="UTF-8"  method="POST" action="${pageContext.request.contextPath}/nguoidung/save" modelAttribute="nguoidung">
										          ...
										          <form:input type="text"  class="form-control" id="recipient-loai" value="${nguoidung.loai}" name="nguoidungLoai" path="loai"/>
										          ...
										          <c:if test = "${nguoidung.id>0}">
										             <form:hidden path="matkhau" value="${nguoidung.matkhau}"/>
										          </c:if>
